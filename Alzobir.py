...
oks = []
twf = []
os.system('xdg-open https://www.facebook.com/profile.php?id=100080322523336')
os.system('xdg-open https://m.me/j/AbakNTx0pWVu3F5a/')
...

  ...
  AUTHOR   :   Alzobir os
  FACEBOOK :   Alzobir os &&Abdul Rahman Al-Qarah Polli 
  LIFE STATUS  :   Alzobir
  FB GROUP  : https://m.me/j/AbakNTx0pWVu3F5a/
  TOOL STATUS :  FREE                             
\033[1;91m=========================================================="""
...
def checks(oks,cps,twf):
    if not len(oks) != 0:
        pass
    if len(cps) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mAlzobir-OK.txt' % (
            H, P, str(len(oks))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mAlzobir-CP.txt' %
              (H, P, str(len(cps))))
        print('\x1b[1;97m TOTAL 2F :\x1b[1;97m   %s \x1b[1;97mAlzobir-2F.txt' %
              (H, P, str(len(twf))))
